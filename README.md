...
The probabilities for each classification (run model outputs through softmax) can be used to get an expected value for the Tweet sentiment. Here, negative and positive values correspond with negative and positive sentiment.
